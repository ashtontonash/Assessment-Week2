...
function canWeDeliver(zipCode){
    {if (zipCode.isArray(deliveryAreaZipCodes))
...
for (i = 0; i <= deliveryAreaZipCodes[i]; i++){
...
let newDeal = title.replace('10% Off!')
...
let newTimeline = desc.replace("This deal lasts until the end of April!")